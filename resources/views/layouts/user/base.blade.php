...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets3/css/owl.theme.default.min.css')}}">
    ...
    <!-- Boxicons Min CSS --> 
    <link rel="stylesheet" href="{{asset('assets3/css/boxicons.min.css')}}"> 
    <!-- Magnific Popup Min CSS --> 
    <link rel="stylesheet" href="{{asset('assets3/css/magnific-popup.min.css')}}"> 
    <!-- Flaticon CSS --> 
    <link rel="stylesheet" href="{{asset('assets3/css/flaticon.css')}}">
    <!-- Meanmenu Min CSS -->
    <link rel="stylesheet" href="{{asset('assets3/css/meanmenu.min.css')}}">
    <!-- Nice Select Min CSS -->
    {{-- <link rel="stylesheet" href="{{asset('assets3/css/nice-select.min.css')}}"> --}}
    <!-- Odometer Min CSS-->
    <link rel="stylesheet" href="{{asset('assets3/css/odometer.min.css')}}">
    <!-- Date Picker CSS-->
    <link rel="stylesheet" href="{{asset('assets3/css/date-picker.min.css')}}">
    <!-- Muli Fonts Min CSS-->
    <link rel="stylesheet" href="{{asset('assets3/css/muli-fonts.css')}}">
    <!-- Style CSS -->
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{asset('assets3/images/favicon.png')}}">
    <!-- Title -->
...
.footer-area.footer-area-two .single-footer-widget .social-icon li a i {
    ...
    <!-- End Go Top Area -->
        ...
        </script><script src="{{asset('assets3/js/jquery.min.js')}}"></script>
        <!-- Popper Min JS -->
        <script src="{{asset('assets3/js/popper.min.js')}}"></script>
        <!-- Bootstrap Min JS -->
        <script src="{{asset('assets3/js/bootstrap.min.js')}}"></script>
        <!-- Meanmenu Min JS -->
    <script src="{{asset('assets3/js/meanmenu.min.js')}}"></script>
    <!-- Wow Min JS -->
        <script src="{{asset('assets3/js/wow.min.js')}}"></script>
        <!-- Owl Carousel Min JS -->
    <script src="{{asset('assets3/js/owl.carousel.min.js')}}"></script>
        <!-- Nice Select Min JS -->
    {{-- <script src="{{asset('assets3/js/nice-select.min.js')}}"></script> --}}
        <!-- Magnific Popup Min JS -->
    <script src="{{asset('assets3/js/magnific-popup.min.js')}}"></script>
    <!-- Mixitup JS --> 
    <script src="{{asset('assets3/js/jquery.mixitup.min.js')}}"></script>
    <!-- Appear Min JS --> 
        <script src="{{asset('assets3/js/appear.min.js')}}"></script>
    <!-- Odometer Min JS --> 
    <script src="{{asset('assets3/js/odometer.min.js')}}"></script>
    <!-- Range Slider Min JS --> 
    <script src="{{asset('assets3/js/range-slider.min.js')}}"></script>
    <!-- Datepicker Min JS --> 
    <script src="{{asset('assets3/js/bootstrap-datepicker.min.js')}}"></script>
    <!-- Form Validator Min JS -->
    <script src="{{asset('assets3/js/form-validator.min.js')}}"></script>
    <!-- Contact JS -->
    <script src="{{asset('assets3/js/contact-form-script.js')}}"></script>
    <!-- Ajaxchimp Min JS -->
    ...
    <script>
      ...
      window.addEventListener('resume_updated', event => {
            Swal.fire('Success', 'Resume Send Successfully!', 'success');
        })

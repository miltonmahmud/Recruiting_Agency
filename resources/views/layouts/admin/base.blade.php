...
.footer-area.footer-area-two .single-footer-widget .social-icon li a i {
            ...
            <nav class="navbar navbar-expand-md navbar-light">
              ...
              <div class="collapse navbar-collapse mean-menu">
                ...
                <div class="others-option">
                  <div class="get-quote">
                    <a href="{{route('admin.job-post')}}" class="default-btn main-btn">
                      Post a Job
                    </a>
                  </div>
                </div>
    ...
    <script>
      ...
      window.addEventListener('serviceDelete', event => {
            Swal.fire('Deleted', 'Service Deleted Successfully!', 'success');
        })

      window.addEventListener('postDelete', event => {
            Swal.fire('Deleted', 'Post Deleted Successfully!', 'success');
        })

      window.addEventListener('FaqDelete', event => {
            Swal.fire('Deleted', 'FAQ Deleted Successfully!', 'success');
        })

      window.addEventListener('clientDelete', event => {
            Swal.fire('Deleted', 'Client Deleted Successfully!', 'success');
        })

      window.addEventListener('addPost', event => {
            Swal.fire('Success', 'Job Post Created Successfully!', 'success');
        })

      window.addEventListener('postUpdate', event => {
            Swal.fire('Success', 'Job Post Updated Successfully!', 'success');
        })
      ...
      window.addEventListener('faq_created', event => {
            Swal.fire('Success', 'New FAQ Created Successfully!', 'success');
        })

      window.addEventListener('faq-updated', event => {
            Swal.fire('Success', 'FAQ Updated Successfully!', 'success');
        })

      window.addEventListener('addtestimonial', event => {
            Swal.fire('Success', 'Testimonial Created Successfully!', 'success');
        })

      window.addEventListener('service_created', event => {
            Swal.fire('Success', 'New Service Created Successfully!', 'success');
        })
      ...
      window.addEventListener('about_updated', event => {
      ...
      window.addEventListener('password-changed', event => {
       ...
       window.addEventListener('testimonialDelete', event => {
            Swal.fire('Success', 'Testimonial Deleted Successfully!', 'success');
        })

       window.addEventListener('setasEmployer', event => {
            Swal.fire('Success', 'User set as Employer Successfully!', 'success');
        })

       window.addEventListener('setasUser', event => {
            Swal.fire('Success', 'User set as User Successfully!', 'success');
        })

       window.addEventListener('updateBanner', event => {
       ...
       window.addEventListener('client_added', event => {

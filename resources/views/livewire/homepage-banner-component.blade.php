		...
		<section class="candidates-dashboard-area ptb-70">
			<div class="container">
					...
					<div class="col-lg-4">
						<div class="avatar-sidebar">
							...
							<ul>
								...
								<li>
									<a href="{{route('admin.homepage-banner')}}" class="active">Homepage Banner</a>
								</li>
								<li>
				...
				<div class="job-information">
					...
					<form action="" wire:submit.prevent="updateBanner">
						<div class="row">
							...
							<div class="col-lg-12">
								<div class="form-group">
                                    ...
                                    @else
                                      <img src="{{asset('assets/images/banner')}}/{{$image}}" width="100%" />
                                    @endif
								</div>
							</div>
